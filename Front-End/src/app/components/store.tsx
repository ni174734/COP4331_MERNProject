      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredGames.map((game) => (
            <div
              key={game.id}
              className="bg-slate-900 rounded-xl overflow-hidden flex flex-col h-full hover:transform hover:scale-105 transition-all duration-300 border border-slate-800 hover:border-orange-500/50"
            >
